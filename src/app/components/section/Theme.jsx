...
export default function Theme() {
  return (
    <section className="relative py-32 pt-72 lg:pt-0 flex flex-col-reverse lg:flex-row justify-between items-center lg:mt-32">
      <div className="relative text-cream_nogen bg-hitam_nogen py-12 px-10 w-full lg:w-[70%]">
        <Image
          src="/theme/motor.png"
          width={550}
          height={854}
        ...
        <p className="opacity-50">Get to Know Our Theme</p>
        <h1
        ...
        <p className="w-full xl:w-[90%] leading-7">
